...
tabSelectItem.forEach((tabSelect, index) => {
  tabSelect.addEventListener("click", function () {
    ...
    tabSelectItem[CURRENT_TAB_SELECT].classList.remove(TYPE_POSITION_TAB.center);

    tabSelect.classList.add(TYPE_POSITION_TAB.center);
    tabSelectItem[CURRENT_TAB_SELECT].classList.add(TYPE_POSITION_TAB[tabPositionSelect]);
